...
pkgs<- c( "ggplot2", "dplyr", "ggplot2", "magrittr", "here", "usmap", "sbtools", "devtools")
...
zip_files <- unzip_data(abbrevs) # unzip data and save an object containing the directories
```
<!-- The following files are available on disk and ready to use: -->
<!-- ```{r list_avail_files, include=FALSE} -->
